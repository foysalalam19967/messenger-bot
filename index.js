...
const replies = [
  ...
  {
    keywords: ["মেয়েদের জিনিস", "মেয়েদের পণ্য", "girls item", "ladies item"],
  ...
  {
    keywords: ["কিসের মাধ্যমে পাঠাবেন", "কুরিয়ার", "courier", "কিভাবে পাঠাবেন"],
    reply:
  ...
  {
    keywords: ["দুইটা এক সাথে", "একাধিক পিস", "কয়েকটা নিলে চার্জ", "multiple item charge"],
    reply:
  ...
  {
    keywords: ["দেখে নিতে পারব", "দেখে নেওয়া যাবে", "check kore nite parbo"],
    reply:
  ...
  // ==== এক্সচেঞ্জ/রিটার্ন ====
  {
    keywords: ["এক্সচেঞ্জ", "রিটার্ন", "exchange", "return", "ফেরত", "পাল্টানো"],
    reply:
